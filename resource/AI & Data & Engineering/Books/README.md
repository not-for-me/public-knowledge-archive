...
기술 서적들을 챕터별로 정리한 요약 모음입니다. 각 챕터는 핵심 내용을 한국어로 요약하여 빠르게 참조할 수 있도록 작성되었습니다.

## 목록

### 🤖 [AI Engineering](./ai_engineering)
Foundation model 기반 AI 애플리케이션 구축을 위한 엔지니어링 전반.
📖 책: [AI Engineering: Building Applications with Foundation Models](https://www.amazon.com/AI-Engineering-Building-Applications-Foundation/dp/1098166302)
...
### 🤖 [Building Agentic AI Systems](./building_agentic_ai_systems)
추론·계획·적응이 가능한 자율 AI 에이전트 설계와 구현.
📖 책: [Building Agentic AI Systems (Amazon)](https://www.amazon.com/Building-Agentic-Systems-intelligent-autonomous/dp/1803238755)
...
### 🌐 [Building Knowledge Graphs](./building_knowledge_graphs)
지식 그래프 설계·구축부터 데이터 사이언스·ML·시맨틱 검색 활용까지.
📖 책: [Building Knowledge Graphs (Amazon)](https://www.amazon.com/dp/1098127102)
...
### 🕸️ [Building AI Agents with LLMs, RAG, and Knowledge Graphs](./building_aI_agents_with_llms_rag_knowledge_graphs)
LLM·RAG·지식 그래프를 결합한 자율 AI 에이전트 구축 실전 가이드.
📖 책: [Building AI Agents with LLMs, RAG, and Knowledge Graphs (Amazon)](https://www.amazon.com/Building-Agents-LLMs-Knowledge-Graphs/dp/183508706X)
...
### 🤝 [Driving Data Quality with Data Contracts](./driving_data_quality_with_data_contracts)
데이터 컨트랙트로 신뢰할 수 있는 데이터 플랫폼 구축하기.
📖 책: [Driving Data Quality with Data Contracts (Amazon)](https://www.amazon.com/Driving-Data-Quality-Contracts-comprehensive/dp/1837635005)
...
### 🏛️ [Fundamentals of Software Architecture (2nd Edition)](./fundamentals_of_sw_arch_2nd)
소프트웨어 아키텍처 특성, 스타일, 그리고 아키텍트의 소프트 스킬.
📖 책: [Fundamentals of Software Architecture, 2nd Edition (Amazon)](https://www.amazon.com/Fundamentals-Software-Architecture-Engineering-Approach/dp/1098175514)
...
### 🛠️ [Fundamentals of Software Engineering](./fundamentals_of_software_engineering)
코더에서 엔지니어로 — 소프트웨어 개발 전 과정과 커리어 역량.
📖 책: [Fundamentals of Software Engineering: From Coder to Engineer (Amazon)](https://www.amazon.com/Fundamentals-Software-Engineering-Coder-Engineer/dp/109814323X)
...
### 🐘 [Just Use Postgres!](./just_use_postgres)
PostgreSQL의 핵심 기능과 실전 활용.
📖 책: [Just Use Postgres! (Amazon)](https://www.amazon.com/Just-Use-Postgres-database-need/dp/1633435695)
...
### 🔗 [Neo4j: The Definitive Guide](./neo4j_the_definitive_guide)
프로덕션 레디 그래프 구현을 위한 Neo4j 실전 레시피.
📖 책: [Neo4j: The Definitive Guide (Amazon)](https://www.amazon.com/Neo4j-Definitive-Hands-Production-Implementations/dp/1098165659)
...
### 🐍 [Effective Python (3rd Edition)](./effective_python_3rd)
더 나은 파이썬 코드를 작성하기 위한 베스트 프랙티스 모음.
📖 책: [Effective Python, 3rd Edition (Amazon)](https://www.amazon.com/Effective-Python-Specific-Software-Development/dp/0138172234)
...
### ⚡ [High Performance Python (3rd Edition)](./high_performance_python_3rd)
프로파일링부터 컴파일·병렬화·메모리 최적화까지 파이썬 성능 극대화.
📖 책: [High Performance Python, 3rd Edition (Amazon)](https://www.amazon.com/High-Performance-Python-Performant-Programming/dp/1098165969)
...
### 🧭 [Essential GraphRAG](./essential_graphrag)
Knowledge Graph-Enhanced RAG — LLM 정확도 향상부터 벡터 검색·Cypher 생성·Agentic RAG·GraphRAG 구현까지 실전 가이드.
📖 책: [Essential GraphRAG: Knowledge Graph-Enhanced RAG (Amazon)](https://www.amazon.com/Essential-GraphRAG-Knowledge-Graph-Enhanced-RAG/dp/1633436268)
...
### ⛵ [Learning Helm](./learning_helm)
Kubernetes 패키지 매니저 Helm의 기초부터 고급 템플릿 개발, 차트 저장소, 플러그인까지.
📖 책: [Learning Helm: Managing Apps on Kubernetes (Amazon)](https://www.amazon.com/Learning-Helm-Managing-Apps-Kubernetes/dp/1492083658)

<details>
<summary>챕터 목록 (8)</summary>

- [01. Introducing Helm](learning_helm/01-introducing-helm.md)
- [02. Using Helm](learning_helm/02-using-helm.md)
- [03. Beyond the Basics with Helm](learning_helm/03-beyond-the-basics-with-helm.md)
- [04. Building a Chart](learning_helm/04-building-a-chart.md)
- [05. Developing Templates](learning_helm/05-developing-templates.md)
- [06. Advanced Chart Features](learning_helm/06-advanced-chart-features.md)
- [07. Chart Repositories](learning_helm/07-chart-repositories.md)
- [08. Helm Plugins and Starters](learning_helm/08-helm-plugins-and-starters.md)

</details>

### 🚢 [Managing Kubernetes Resources Using Helm (2nd Edition)](./managing_kubernetes_resources_using_helm_second_ed)
Helm으로 Kubernetes 리소스 구축·패키징·배포 — 환경 설정부터 의존성 관리·템플릿·후크·테스팅·GitOps·보안까지.
📖 책: [Managing Kubernetes Resources Using Helm, 2nd Edition (Amazon)](https://www.amazon.com/Managing-Kubernetes-Resources-Using-Helm/dp/1803242892)

<details>
<summary>챕터 목록 (12)</summary>

- [01. Understanding Kubernetes and Helm](managing_kubernetes_resources_using_helm_second_ed/01-understanding-kubernetes-and-helm.md)
- [02. Preparing a Kubernetes and Helm Environment](managing_kubernetes_resources_using_helm_second_ed/02-preparing-a-kubernetes-and-helm-environment.md)
- [03. Installing Your First App with Helm](managing_kubernetes_resources_using_helm_second_ed/03-installing-your-first-app-with-helm.md)
- [04. Scaffolding a New Helm Chart](managing_kubernetes_resources_using_helm_second_ed/04-scaffolding-a-new-helm-chart.md)
- [05. Helm Dependency Management](managing_kubernetes_resources_using_helm_second_ed/05-helm-dependency-management.md)
- [06. Understanding Helm Templates](managing_kubernetes_resources_using_helm_second_ed/06-understanding-helm-templates.md)
- [07. Helm Lifecycle Hooks](managing_kubernetes_resources_using_helm_second_ed/07-helm-lifecycle-hooks.md)
- [08. Publishing to a Helm Chart Repository](managing_kubernetes_resources_using_helm_second_ed/08-publishing-to-a-helm-chart-repository.md)
- [09. Testing Helm Charts](managing_kubernetes_resources_using_helm_second_ed/09-testing-helm-charts.md)
- [10. Automating Helm with CD and GitOps](managing_kubernetes_resources_using_helm_second_ed/10-automating-helm-with-cd-and-gitops.md)
- [11. Using Helm with the Operator Framework](managing_kubernetes_resources_using_helm_second_ed/11-using-helm-with-the-operator-framework.md)
- [12. Helm Security Considerations](managing_kubernetes_resources_using_helm_second_ed/12-helm-security-considerations.md)
